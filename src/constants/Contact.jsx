              ...
              <div className="">
                <div className="flex flex-col justify-center items-center m-[200px] gap-2.5">
                  ...
                  <button
                    ...
                    className="px-7 py-2.5 bg-[#0000ff] hover:text-[#0000ff] hover:bg-white hover:outline-2 hover:outline-[#0000ff] rounded-[20px] text-white text-3xl cursor-pointer font-satoshi"
                  >
                    Get in touch
                  </button>
                </div>
